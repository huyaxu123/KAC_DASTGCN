...
def get_parameters():
    ...
    parser.add_argument('--numZ', type=int, default=2, help='Embedding dimension')
    ...
    parser.add_argument('--thr', type=float, default=0.8, help='Threshold value between 0 and 1')
    ...
    blocks = [ [1], [64, 64],  [64, 64], [64, 256], [1]]   #网络层数
